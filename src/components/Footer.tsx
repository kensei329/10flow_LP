      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 leading-relaxed">
              医療機関の持続的な成長と患者様の真の価値創出を両立し、<br />
              収益性と倫理性を兼ね備えた自由診療をサポートします。<br />
              AI価格戦略×決済×サブスクで稼働率と単価を最適化し、<br />
              次のステージへの成長を実現する総合ソリューションを提供いたします。
            </p>
        ...
        <div className="hidden">
          ...
          <p>
            ...
            AI価格戦略×決済×サブスクで稼働率と単価を最適化し、持続的な収益成長を実現。
          ...
          <h5>期待できる成果</h5>
          <p>
            売上向上、利益率改善、稼働率最適化、患者満足度向上、リピート率向上、
            新規患者獲得、収益の安定化、持続的な成長
          </p>
        </div>
      </div>
    </footer>
