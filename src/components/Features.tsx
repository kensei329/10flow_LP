...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      title: "まずは10秒で仮申込み",
      subtitle: "CV率最適化",
      description: "まずはStep1で連絡先と希望メニューだけを入力して送信。続くStep2で、症状や希望条件を任意で詳しく伺います。初回入力の負担を抑え、コンバージョン率を高める設計です。",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      id: "F9",
      title: "外国人インバウンド対応",
      subtitle: "メディカルツーリズム連携",
      description: "外国人患者向けの多言語対応、ビザサポート、現地コーディネーターとの連携により、メディカルツーリズム市場への参入を支援。",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const categories = [
    ...
    { name: "国際展開・新市場", color: "bg-orange-100 text-orange-800" }
  ]
